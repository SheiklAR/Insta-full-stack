...
import { faCompass, faClipboard, faPlusSquare, faPaperPlane } from '@fortawesome/free-regular-svg-icons'
const NavBar = () => {
  return (
    <div>
      <div className='border-t space-x-2 my-2 py-2  inline-flex items-center justify-between inset-0 bottom-0'>
        <NavIcon icon={faHome} />
